...
SECRET_KEY = config('SECRET_KEY', default='your-user-service-secret-key')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Energy Management System - User Service API',
    'DESCRIPTION': 'User Management Service for Energy Management System',
    'VERSION': '1.0.0',
